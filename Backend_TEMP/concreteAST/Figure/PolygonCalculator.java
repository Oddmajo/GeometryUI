...
public class PolygonCalculator
{
    ...
    public ArrayList<ArrayList<Polygon>> GetPolygons() throws ArgumentException 
    {
        if(polygons == null)
        {
    ...
    //
    public void CalculateImpliedPolygons() throws ArgumentException 
    {
    ...
    private void InductivelyConstructPolygon(ArrayList<ArrayList<Integer>> openPolygonSets, boolean[][] eligible,
            ArrayList<ArrayList<Integer>> constructedPolygonSets) throws ArgumentException
    {
