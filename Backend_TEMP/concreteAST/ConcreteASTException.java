 ...
 *
 */
public class ConcreteASTException extends Exception
{
     ...
     */
    private static final long serialVersionUID = 612619512226592950L;
     ...
     * @author Drew Whitmire
     */
    public ConcreteASTException(String message)
    {
        super(message);
    }
     ...
     * @author Drew Whitmire
     */
    public ConcreteASTException(Throwable cause)
    {
        super(cause);
    }
     ...
     * @author Drew Whitmire
     */
    public ConcreteASTException(String message, Throwable cause)
    {
        super(message, cause);
    }
     ...
     * @author Drew Whitmire
     */
    public ConcreteASTException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace)
    {
