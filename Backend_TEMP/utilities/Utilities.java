...
public class Utilities
{
    ...
    /* **************************************************************************************************
     * Comment everything out because I don't need to deal with anything besides a few methods right now
    ...
    //
    public static <T extends concreteAST.GroundedClause> T GetStructurally(List<T> list, T t)
    {
        for (T oldT : list)
        {
