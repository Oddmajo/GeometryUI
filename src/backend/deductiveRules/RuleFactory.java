...
// @author C. Alvin
//
// The intent of this class is to provide external access to all the rules of geometry.
//  We do this two ways:
//     Provide access to an enumeration (interger-based) representation of the rules.
//     Provide a factory mechanism for each rule.
//       We only need a single instance of each rule, therefore, this class provide an intermediary interface.
//
...
//        }
        ...
        public static boolean RELATION_TRANSITIVE_SUBSTITUTION = true;
        public static boolean TRANSITIVE_SUBSTITUTION = true;
        public static boolean ANGLE = true;

        //
        // Axioms
        //
        public static boolean AA_SIMILARITY = true;
        public static boolean ANGLE_ADDITION_AXIOM = true;
        public static boolean ASA = true;
        public static boolean CONGRUENT_CORRESPONDING_ANGLES_IMPLY_PARALLEL = true;
        public static boolean CORRESPONDING_ANGLES_OF_PARALLEL_LINES = true;
        public static boolean SEGMENT_ADDITION_AXIOM = true;
        public static boolean SAS_CONGRUENCE = true;
        public static boolean SSS = true;
        public static boolean ANGLES_OF_EQUAL_MEASUREARE_CONGRUENT = true;
        public static boolean TRANSITIVE_CONGRUENT_ANGLE_WITH_RIGHT_ANGLE = true;
        public static boolean ARC_ADDITION_AXIOM = true;

        //
        // Definitions
        //
        public static boolean ALTITUDE_DEFINITION = true;
        public static boolean ANGLE_BISECTOR_DEFINITION = true;
        public static boolean COMPLEMENTARY_DEFINITION = true;
        public static boolean CONGRUENT_SEGMENTS_IMPLY_PROPORTIONAL_SEGMENTS_DEFINITION = true;
        public static boolean ISOSCELES_TRIANGLE_DEFINITION = true;
        public static boolean EQUILATERAL_TRIANGLE_DEFINITION = true;
        public static boolean MEDIAN_DEFINITION = true;
        ...
        public static boolean SUPPLEMENTARY_DEFINITION = true;
        public static boolean STRAIGHT_ANGLE_DEFINITION = true;

        // Quadrilateral Defs
        public static boolean QUADRILATERAL_DEFINITION = true;
        public static boolean KITE_DEFINITION = true;
        public static boolean PARALLELOGRAM_DEFINITION = true;
        public static boolean RHOMBUS_DEFINITION = true;
        public static boolean SQUARE_DEFINITION = true;
        public static boolean RECTANGLE_DEFINITION = true;
        public static boolean TRAPEZOID_DEFINITION = true;
        public static boolean ISOSCELES_TRAPEZOID_DEFINITION = true;

        //
        // Theorems
        //
        public static boolean AAS = true;
        public static boolean ACUTE_ANGLES_IN_RIGHT_TRIANGLE_ARE_COMPLEMENTARY = true;
        public static boolean ADJACENT_ANGLES_PERPENDICULAR_IMPLY_COMPLEMENTARY = true;
        public static boolean ALT_INT_CONGRUENT_ANGLES_IMPLY_PARALLEL = true;
        public static boolean ALTITUDE_OF_RIGHT_TRIANGLES_IMPLIES_SIMILAR = true;
        public static boolean ANGLE_BISECTOR_IS_PERPENDICULAR_BISECTOR_IN_ISOSCELES = true;
        public static boolean ANGLE_BISECTOR_THEOREM = true;
        public static boolean CONGRUENT_SUPPLEMENTARY_ANGLES_IMPLY_RIGHT_ANGLES = true;
        public static boolean CONGRUENT_ADJACENT_ANGLES_IMPLY_PERPENDICULAR = true;
        public static boolean CONGRUENT_ANGLES_IN_TRIANGLE_IMPLY_CONGRUENT_SIDES = true;
        public static boolean CONGRUENT_SIDES_IN_TRIANGLE_IMPLY_CONGRUENT_ANGLES = true;
        public static boolean EXTERIOR_ANGLE_EQUAL_SUM_REMOTE_ANGLES = true;
        public static boolean EQUILATERAL_TRIANGLE_HAS_SIXTY_DEGREE_ANGLES = false;
        public static boolean HYPOTENUSE_LEG = true;
        public static boolean ISOSCELES_TRIANGLE_THEOREM = true;
        ...
        public static boolean TRANSITIVE_SIMILAR = true;
        public static boolean TRIANGLE_PROPORTIONALITY = true;
        public static boolean TWO_PAIRS_CONGRUENT_ANGLES_IMPLY_THIRD_PAIR_CONGRUENT = true;
        public static boolean VERTICAL_ANGLES = true;

        // Quadrilateral
        public static boolean OPPOSITE_SIDES_PARALLELOGRAM_ARE_CONGRUENT = true;
        public static boolean OPPOSITE_ANGLES_PARALLELOGRAM_ARE_CONGRUENT = true;
        public static boolean DIAGONALS_PARALLELOGRAM_BISECT_EACH_OTHER = true;
        public static boolean OPPOSITE_SIDES_CONGRUENT_IMPLIES_PARALLELOGRAM = true;
        public static boolean ONE_PAIR_OPPOSITE_SIDES_CONGRUENT_PARALLEL_IMPLIES_PARALLELOGRAM = true;
        public static boolean OPPOSITE_ANGLES_CONGRUENT_IMPLIES_PARALLELOGRAM = true;
        public static boolean DIAGONALS_BISECT_EACH_OTHER_IMPLY_PARALLELOGRAM = true;
        public static boolean DIAGONALS_OF_RECTANGLE_ARE_CONGRUENT = true;
        public static boolean DIAGONALS_OF_KITE_ARE_PERPENDICULAR = true;
        public static boolean DIAGONALS_OF_RHOMBUS_ARE_PERPENDICULAR = true;
        public static boolean DIAGONALS_OF_RHOMBUS_BISECT_ANGLES_OF_RHOMBUS = true;
        public static boolean TWO_CONSECUTIVE_SIDES_OF_PARALLELOGRAM_CONGRUENT_IMPLY_RHOMBUS = true;
        public static boolean BASE_ANGLES_OF_ISOSCELES_TRAPEZOID_CONGRUENT = true;
        public static boolean MEDIAN_TRAPEZOID_PARALLEL_TO_BASE = true;
        public static boolean MEDIAN_TRAPEZOID_LENGTH_HALF_SUM_BASES = true;

        // Circles
        public static boolean CIRCLE_DEFINITION = true;
        public static boolean TANGENT_IS_PERPENDICULAR_TO_RADIUS = true;
        public static boolean PERPENDICULAR_TO_RADIUS_IS_TANGENT = true;
        public static boolean TANGENT_TO_CIRCLE_ARE_CONGRUENT_FROM_SAME_POINT = true;
        public static boolean MINOR_ARCS_CONGRUENT_IF_CENTRAL_ANGLE_CONGRUENT = true;
        public static boolean CENTRAL_ANGLES_CONGRUENT_IF_MINOR_ARCS_CONGRUENT = true;
        public static boolean CONGRUENT_CHORDS_HAVE_CONGRUENT_ARCS = true;
        public static boolean CONGRUENT_ARCS_HAVE_CONGRUENT_CHORDS = true;
        public static boolean DIAMETER_PERPENDICULAR_TO_CHORD_BISECTS_CHORD_AND_ARC = true;
        public static boolean MEASURE_INSCRIBED_ANGLE_EQUAL_HALF_INTERCEPTED_ARC = true;
        public static boolean CIRCLE_CONGRUENCE_DEFINITION = true;
        public static boolean ANGLE_INSCRIBED_SEMICIRCLE_IS_RIGHT = true;
        public static boolean CENTRAL_ANGLE_EQUAL_MEASURE_INTERCEPTED_ARC = true;
        public static boolean CHORD_AND_TANGENT_ANGLE_IS_HALF_INTERCEPTED_ARC = true;
        public static boolean EXTERIOR_ANGLE_HALF_DIFFERENCE_INTERCEPTED_ARCS = true;
        public static boolean TWO_INTERSECTING_CHORDS_ANGLE_MEASURE_HALF_SUM_INTERCEPTED_ARCS = true;
        public static boolean TWO_INTERCEPTED_ARCS_HAVE_CONGRUENT_ANGLES = true;
        public static boolean INSCRIBED_QUADRILATERAL_OPPOSITE_ANGLES_SUPPLEMENTARY = true;

        //
        // General Switches
        //
        public static boolean QUADRILATERALS = true;
        public static boolean SIMILARITY = true;
        public static boolean TRIANGLE_CONGREUNCE = true;
        public static boolean REFLEXIVE = true;
