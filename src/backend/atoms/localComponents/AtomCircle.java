package backend.atoms.localComponents;
...
// <summary>
// This class extends the figure circle to maintain any Atomic Region calculation information.
// These objects are Comparable based on the size of their radii.
// </summary>
public class AtomCircle extends Circle implements Comparable<AtomCircle>
{
    private AtomCircle() { super(Point.ORIGIN, 1); }

//    // A copy constructor of sorts
//    public AtomCircle(Circle c)
//    {
//        super(c);
//    }

    public int compareTo(AtomCircle that)
    {
        if (that == null) return 1;
        
        if (this._radius < that._radius) return -1;

        if (that._radius < this._radius) return 1;
        
        return 0;
    }
    
//    public static ArrayList<AtomCircle> getFigureCircles()
//    {
...
//    public AtomCircle(Point _center, double r)
//    {
//        super();
//        
...
//        if (!(that instanceof AtomCircle)) return false;
//        AtomCircle thatCirc = (AtomCircle)that;
//
...
//    //
//    public void FindIntersection(AtomCircle thatCircle, OutPair<Point, Point> out)
//    {
//        Point inter1 = null;
//        Point inter2 = null;
//
...
//    //
//    public boolean AreConcentric(AtomCircle thatCircle)
//    {
...
//    //
//    public boolean AreOrthognal(AtomCircle thatCircle)
//    {
...
//    //
//    public Point AreTangent(AtomCircle thatCircle)
//    {
//        // Find the intersection points
//        OutPair<Point, Point> out = new OutPair<Point, Point>();
//        this.FindIntersection(thatCircle, out);
...
//    }
//
//    public static ArrayList<AtomCircle> IsCentralAngle(Angle angle)
//    {
//        ArrayList<AtomCircle> circles = new ArrayList<AtomCircle>();
//
//        for (AtomCircle circle : figureCircles)
//        {
...
//    }
//
//    public static ArrayList<AtomCircle> IsInscribedAngle(Angle angle)
//    {
//        ArrayList<AtomCircle> circles = new ArrayList<AtomCircle>();
//
//        for (AtomCircle circle : figureCircles)
...
//    }
//
//    public static ArrayList<AtomCircle> GetChordCircles(Segment segment)
//    {
//        ArrayList<AtomCircle> circles = new ArrayList<AtomCircle>();
//
//        for (AtomCircle circle : figureCircles)
...
//    }
//
//    public static ArrayList<AtomCircle> GetSecantCircles(Segment segment)
//    {
//        ArrayList<AtomCircle> secCircles = new ArrayList<AtomCircle>();
//
//        for (AtomCircle circle : figureCircles)
//        {
...
//    }
//
//    public boolean CircleContains(AtomCircle that)
//    {
...
//        if (!(obj instanceof AtomCircle)) return false;
//        AtomCircle thatCircle = (AtomCircle)obj;
//
...
//    //
//    private boolean ContainsCircle(AtomCircle that)
//    {
...
//        figureCircles.clear();
//    }
//    public static ArrayList<AtomCircle> figureCircles = new ArrayList<AtomCircle>();
//    public static void Record(GroundedClause clause)
//    {
//        // Record uniquely? For right angles, etc?
//        if (clause instanceof AtomCircle) figureCircles.add((AtomCircle)clause);
//    }
//    public static AtomCircle GetFigureCircle(Point cen, double rad)
//    {
//        AtomCircle candCircle = new AtomCircle(cen, rad);
//
...
//    }
//
//    public static ArrayList<AtomCircle> GetFigureCirclesBy_radius(Segment _radius)
//    {
//        ArrayList<AtomCircle> circles = new ArrayList<AtomCircle>();
//
//        for (AtomCircle circle : figureCircles)
