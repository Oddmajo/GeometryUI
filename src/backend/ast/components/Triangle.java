...
import ast.figure.components.triangles.EquilateralTriangle;
import ast.figure.components.triangles.IsoscelesTriangle;
...
//    }
    ...
    public boolean CoordinateAltitude(Segment thatSegment)
    {
        ...
        if (this.HasSegment(thatSegment) && this.isRight)
        {
            ...
            if (utilities.math.Utilities.doubleEquals(this.AngleA.measure, 90)) return AngleA.HasSegment(thatSegment);
            if (utilities.math.Utilities.doubleEquals(this.AngleB.measure, 90)) return AngleB.HasSegment(thatSegment);
            if (utilities.math.Utilities.doubleEquals(this.AngleC.measure, 90)) return AngleC.HasSegment(thatSegment);
        }
        ...
        return utilities.math.Utilities.doubleEquals((new Angle(thisIntersection, otherIntersection, oppSide.getPoint1())).measure, 90);
    }
