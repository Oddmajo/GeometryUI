...
////    public abstract boolean FindIntersection(Segment that, OutPair<Point, Point> out) { out.set(null, null); }
...
//        return thisAtomicRegion.Contains(that.GetFigureAsAtomicRegion());
    ...
    // For compilation purposes; to be deleted.
    public boolean contains(Shape that) { throw new IllegalArgumentException(); }
