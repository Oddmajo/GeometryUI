...
public class Ray extends Figure
{
    ...
    public boolean equals(Object obj)
    {
        ...
        return this._origin.structurallyEquals(that._origin) && 
               this._point.structurallyEquals(that._point);
    }

    @Override
    public String toString() { return "Ray(" + _origin.toString() + ", " + _point.toString() + ")"; }
