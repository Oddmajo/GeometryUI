...
public class ColorChooserBeanInfo extends SimpleBeanInfo {
	...
	private static BeanDescriptor getBdescriptor() {
		final BeanDescriptor beanDescriptor = new BeanDescriptor(
				ui.net.java.dev.colorchooser.ColorChooser.class, null); // NOI18N//GEN-HEADEREND:BeanDescriptor
	...
	private static PropertyDescriptor[] getPdescriptor() {
		...
		try {
			properties[PROPERTY_color] = new PropertyDescriptor("color",
					ui.net.java.dev.colorchooser.ColorChooser.class, "getColor",
			"setColor"); // NOI18N
			...
			properties[PROPERTY_continuousPalettePreferred] = new PropertyDescriptor(
					...
					ui.net.java.dev.colorchooser.ColorChooser.class,
			...
			properties[PROPERTY_cursor] = new PropertyDescriptor("cursor",
					ui.net.java.dev.colorchooser.ColorChooser.class, "getCursor",
			"setCursor"); // NOI18N
			properties[PROPERTY_enabled] = new PropertyDescriptor("enabled",
					ui.net.java.dev.colorchooser.ColorChooser.class, "isEnabled",
			"setEnabled"); // NOI18N
			properties[PROPERTY_height] = new PropertyDescriptor("height",
					ui.net.java.dev.colorchooser.ColorChooser.class, "getHeight",
					null); // NOI18N
			...
			properties[PROPERTY_name] = new PropertyDescriptor("name",
					ui.net.java.dev.colorchooser.ColorChooser.class, "getName",
			"setName"); // NOI18N
			...
			properties[PROPERTY_visible] = new PropertyDescriptor("visible",
					ui.net.java.dev.colorchooser.ColorChooser.class, "isVisible",
			"setVisible"); // NOI18N
			properties[PROPERTY_width] = new PropertyDescriptor("width",
					ui.net.java.dev.colorchooser.ColorChooser.class, "getWidth",
					null); // NOI18N
			properties[PROPERTY_x] = new PropertyDescriptor("x",
					ui.net.java.dev.colorchooser.ColorChooser.class, "getX", null); // NOI18N
			properties[PROPERTY_y] = new PropertyDescriptor("y",
					ui.net.java.dev.colorchooser.ColorChooser.class, "getY", null); // NOI18N
