...
public class NewCommandMacro {
	...
	MacroInfo.Commands.put(name, new MacroInfo("ui.latex.NewCommandMacro", "executeMacro", nbargs));
    }
	...
	MacroInfo.Commands.put(name, new MacroInfo("ui.latex.NewCommandMacro", "executeMacro", nbargs, 1));
    }
