...
public class DiagonalsOfRhombusBisectRhombusAnglesTest
{
    ...
    public void test() throws IOException
    {
        ...
        flags.add(RuleFactory.JustificationSwitch.DeductionJustType.DIAGONALS_OF_RHOMBUS_BISECT_ANGLES_OF_RHOMBUS.ordinal());
