...
public class BothPairsOppAnglesCongruentImpliesParallelogramTest
{
    ...
    public void test() throws IOException
    {
        ...
        flags.add(RuleFactory.JustificationSwitch.DeductionJustType.OPPOSITE_ANGLES_CONGRUENT_IMPLIES_PARALLELOGRAM.ordinal());
