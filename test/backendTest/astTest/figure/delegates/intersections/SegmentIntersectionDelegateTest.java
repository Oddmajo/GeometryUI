package backendTest.astTest.figure.delegates.intersections;
...
public class SegmentIntersectionDelegateTest extends FigureDelegate
{
    /*
     * Special case intersection code for a Segment with another segment
    ...
    public static Point findIntersection(Segment thisS, Segment that)
    {
        ...
        if (thisS.coincidingWithoutOverlap(that)) return null;
