...
public class PointLiesOnArcTest extends GenericTester
{
    public PointLiesOnArcTest() { super("PointLiesOnArc Test"); }
    ...
    public void runTest()
    {
        ...
        // Run tests
        //
        _testErrorMap.put("equals", testArcEquality());
        _testErrorMap.put("on", testPointOnArc());
        _testErrorMap.put("not on", testPointNotOnArc());

        // Report; save the fact we ran these tests once
        _passedAllTests = report();
    }

    private int testArcEquality()
    {
...
//        HERE
//        
//        Arc fixedArc = new Arc(fixedCircle, );
