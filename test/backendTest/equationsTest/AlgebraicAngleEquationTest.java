...
import backend.equations.AlgebraicAngleEquation;
...
{
    @Test
    public void algebraicAngleEquationTest()
    {
        System.out.println("Running AlgebraicAngleEquation Test...");
        for (int i = 0; i < 100; i++)
        {
            ...
            try
            {
                ...
                eq2 = new AlgebraicAngleEquation(eq);
