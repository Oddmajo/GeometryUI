...
import backend.equations.GeometricAngleArcEquation;
...
{
    @Test
    public void geometricAngleArcEquationTest()
    {
        System.out.println("Running GeometricAngleArcEquation Test...");
        for (int i = 0; i < 100; i++)
        {
            
            GeometricAngleArcEquation eq = null, eq2 = null;
            try
            {
                eq = new GeometricAngleArcEquation(EquationGenerator.genAdditionEquationPair());
                eq2 = new GeometricAngleArcEquation(eq);
